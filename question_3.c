// Question: Books are identified by an International Standard Book Number (lSBN). ISBNs assigned
...
int main()
{
    ...
    printf(" \n The GSi prefix is: %d",a);
    printf(" \nThe Group identififer is %d",b);
    printf(" \nThe Publisher code is:%d",c);
    printf(" \nItem number is %d",d);
